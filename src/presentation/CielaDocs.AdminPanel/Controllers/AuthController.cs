...
using CielaDocs.AdminPanel.Utils;
        ...
        public async Task<IActionResult> AssertionConsumerService()
        {
            ...
            try {
                ...
                if (dbuser == null)
                {
                    ...
                    claims.Add(new Claim(AccountClaimTypes.UserIdClaimType, dbuser.AspNetUserId));
                    ...
                    claimsIdentity.AddClaim(new Claim("EmplId", (dbuser?.Id ?? 0).ToString()));

                    if (dbuser?.LoginEnabled == false|| dbuser?.UserTypeId!=1)
                    {

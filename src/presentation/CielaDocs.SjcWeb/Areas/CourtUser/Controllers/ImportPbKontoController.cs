    ...
    public class ImportPbKontoController : Controller
    {
        ...
        public ActionResult ImportTypePartial(int? importTypeId)
        {
            switch (importTypeId)
            {
                ...
                case 0: return RedirectToAction("GetImportTypeEntityPartialView", "ImportPbKonto", new { area = "CourtUser" });
                case 1: return RedirectToAction("GetImportTypeExpertPartialView", "ImportPbKonto", new { area = "CourtUser" });

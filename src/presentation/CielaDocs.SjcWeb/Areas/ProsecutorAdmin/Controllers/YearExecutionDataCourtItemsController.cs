...
namespace CielaDocs.SjcWeb.Areas.ProsecutorAdmin.Controllers
{
    ...
    {
        private readonly ILogger<YearExecutionDataCourtItemsController> _logger;
        ...
        public YearExecutionDataCourtItemsController(ILogger<YearExecutionDataCourtItemsController> logger, IConfiguration configuration, ISendGridMailer emailSender,
